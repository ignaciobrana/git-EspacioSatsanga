<?php 
    ...
    include_once './class/business/empleado.php';
    include_once './class/data/empleado.php';
?>

<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <title>Espacio Satsanga - Empleados</title>
        ...
        <script src="./javascript/dbEmpleados.js"></script>
                ...
                <div class="container">
                    <div class="row">
			            <div class="sixteen columns">
                            <p class="tituloListado">Listado de Empleados</p>
                            ...
                            <div id="detailsDialog">
                                <form id="detailsForm">
                                    <div class="tabla">
                                        ...
                                        <div>
                                            <div class="col1"><label for="tipo">Tipo:</label></div>
                                            <div class="col2"><select name="sTipo" id="sTipo"></select></div>
                                        </div>
                                        <div>
