<div class="container">
        ...
        <div class="twelve columns">
            <div class="header_right">
                <div class="header_contacts clearfix">
                    <div class="header_mail">espaciosatsanga@gmail.com</div>
                    <div class="header_phone">4331-3041 int 239 | 113638142</div>
                    <div class="header_loc">Florida 165 – edificio San Martín 3º piso “340”.</div>
                </div>
            </div>
        </div>
        <div class="four columns">
            <div class="header_soc_search clearfix">
                <a href="#" onclick="executePHP('session_destroy');" class="header_cerrarsesion" title="cerrar sesión">cerrar sesión</a>
                <a target="_blank" href="https://www.instagram.com/espaciosatsanga/?hl=es" class="header_soc_instagram" title="Instagram"></a>
                <a target="_blank" href="https://www.facebook.com/espacio.satsanga?fref=ts" class="header_soc_facebook" title="Facebook"></a>
            </div>		
        </div>
    </div>		
    <div class="header  sixteen columns">
        ...
        <div id="logo">
            <a href="./estudiantes.php" title="Espacio Satsanga - Gestión" rel="home">
                <img src="./img/headerlogo.png" style="width:50%;margin-top: -40px;margin-left: 10px;" alt="Espacio Satsanga">
            </a>
        </div>
			 
        <!-- Main Navigation -->
        <div style="margin-top: -85px;" class="custom_menu2">
            <div id="menu" class="menu-menu-1-container">
                <ul>
                    ...
                    <li id="menu-item" class="menu-item">
                        ...
                        <div style="display: none;">
                            <ul class="sub-menu">
                                <li><a href="./recibos.php"><span>Recibos</span></a></li>
                                <li><a href="./facturas.php"><span>Facturas</span></a></li>
                                <li><a href="./liquidacion.php"><span>Liquidación de Sueldos</span></a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <select id="select_menu" onchange="location = this.value">
            ...
            <option value="./recibos.php">&nbsp;&nbsp;&nbsp;&nbsp;Recibos</option>
            <option value="./facturas.php">&nbsp;&nbsp;&nbsp;&nbsp;Facturas</option>
            <option value="./liquidacion.php">&nbsp;&nbsp;&nbsp;&nbsp;Liquidación de sueldos</option>

            <option value="#">Cajas</option>
            <option value="#">&nbsp;&nbsp;&nbsp;&nbsp;Caja Chica</option>
            <option value="./caja-actual.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Actual</option>
            <option value="./historialcc.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Historial</option>
            <option value="./cajagrande.php">&nbsp;&nbsp;&nbsp;&nbsp;Caja Grande</option>

            <option value="#">Tablas Secundarias</option>
            <option value="./clases.php">&nbsp;&nbsp;&nbsp;&nbsp;Clases</option>
